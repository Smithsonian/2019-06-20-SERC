...
venue: "Smithsonian Environmental Research Center"        # brief name of host site without address (e.g., "Euphoric State University")
...
helper: ["Michael Lonneman"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
register: https://forms.gle/dyRUzawoQYqXdWPX8          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
